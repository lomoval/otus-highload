...
func (m *Dialog_20220508_230302) Up() {
  ...
  create_date datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
	...
	CONSTRAINT dialog_FK FOREIGN KEY (creator_id) REFERENCES user(id) ON DELETE RESTRICT
)`)
  ...
  create_timestamp datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
	...
	CONSTRAINT dialog_answer_FK FOREIGN KEY (creator_id) REFERENCES user(id) ON DELETE RESTRICT,
